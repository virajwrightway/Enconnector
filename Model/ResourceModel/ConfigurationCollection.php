...
namespace Wrightwaydigital\Enconnector\Model\ResourceModel;
...
class ConfigurationCollection extends AbstractCollection
{
    ...
    {
        $this->_init(
            'Wrightwaydigital\Enconnector\Model\Configuration',
            'Wrightwaydigital\Enconnector\Model\ResourceModel\Configuration'
        );
    }
}
