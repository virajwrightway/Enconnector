...
namespace Wrightwaydigital\Enconnector\Model\ResourceModel\Syncprocess;
...
//    protected $_eventObject = 'configuration_collection';
    ...
    {
        $this->_init(\Wrightwaydigital\Enconnector\Model\Syncprocess::class, \Wrightwaydigital\Enconnector\Model\ResourceModel\Syncprocess::class);
    }
