...
namespace Wrightwaydigital\Enconnector\Model\ResourceModel\License;
...
//    protected $_eventObject = 'configuration_collection';
    ...
    {
        $this->_init(\Wrightwaydigital\Enconnector\Model\License::class, \Wrightwaydigital\Enconnector\Model\ResourceModel\License::class);
    }
