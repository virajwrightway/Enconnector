...
namespace Wrightwaydigital\Enconnector\Model\ResourceModel\Eposnowcolours;
...
//    protected $_eventObject = 'configuration_collection';
    ...
    {
        $this->_init(\Wrightwaydigital\Enconnector\Model\Eposnowcolours::class, \Wrightwaydigital\Enconnector\Model\ResourceModel\Eposnowcolours::class);
    }
