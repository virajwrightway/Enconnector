...
namespace Wrightwaydigital\Enconnector\Model\ResourceModel\Configuration;
...
//    protected $_eventObject = 'configuration_collection';
    ...
    {
        $this->_init(Wrightwaydigital\Enconnector\Model\Configuration::class, Wrightwaydigital\Enconnector\Model\ResourceModel\Configuration::class);
    }
}
