...
namespace Wrightwaydigital\Enconnector\Model\ResourceModel\Taxmatch;
...
//    protected $_eventObject = 'configuration_collection';
    ...
    {
        $this->_init(\Wrightwaydigital\Enconnector\Model\Taxmatch::class, \Wrightwaydigital\Enconnector\Model\ResourceModel\Taxmatch::class);
    }
